function [dates] = accuracyFunction(img)
    %ACCURACY FUNCTION Compute the accuracy for the date recognition stage of the algorithm
    ...
    dates.FoundDates = expiryDates;
    dates.AllText = detectedText;
